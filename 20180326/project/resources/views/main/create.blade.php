...
@section('content')
    ...
    <!--<form method="post" action="{{route('main.update',$post->num)}}" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{csrf_token()}}">
        <input type="hidden" name="_method" value="put">
    <div>
        <label name="tempo" for="tempo">템포</label>
        <input type="text" name="tempo" class="form-control" value="80"/>
    </div>
    <div>
        <label name="title" for="title">제목</label>
        <input type="text" name="title" class="form-control" value='update'/>
    </div>
    <div>
        <label name="category" for="category">category</label>
        <input type="text" name="category" class="form-control" value="test"/>
    </div>
    <div>
        <label name="comment" for="comment">comment</label>
        <input type="text" name="comment" class="form-control" value="test_comment"/>
    </div>
    <div>
        <label name="score" for="score">악보</label>
        <input type="text" name="score" class="form-control" value="rrrrrrrrrrrrZr"/>
    </div>
...
<script>
    ...
    function sendScore(){
        ...
        history.replaceState(location.href,"create","edit");
    }
    ...
    function overwriteScore(){
        ...
        $.ajax({
            type: "POST",
            url: "{{route('main.update',$post->num)}}",
